...
global.github = 'https://github.com/djalegapremium/Secktor-Md' ;
...
global.website = 'https://github.com/djalegapremium/Secktor-Md' ; //wa.me/+91000000000000
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'DjalegaXd',
  ownername:  process.env.OWNER_NAME || `It'x Suhail`,
  author:  process.env.PACK_AUTHER || 'Djalega++', 
  ...
  caption :process.env.CAPTION || "    *•ᴘᴏᴡᴇʀᴇᴅ ʙʏ Fedora•* ",   //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
